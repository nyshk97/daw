...
inline const juce::Colour markerLaneBg      { 0xff242428 };  // セクションマーカーレーン
...
inline const juce::Colour panelBorder       { 0xff333338 };  // パネル・行の区切り線
...
// ---- セクションマーカー ----
inline const juce::Colour sectionIntro  { 0xffc4813d };  // オレンジ
inline const juce::Colour sectionVerse  { 0xff5da35f };  // 緑
inline const juce::Colour sectionHook   { 0xffc4b04a };  // 黄
inline const juce::Colour sectionBridge { 0xff5b87b8 };  // 青
inline const juce::Colour sectionOutro  { 0xffb05a50 };  // 赤茶
